...
public class MimeTypeExtractor implements ContentTransformer {
   ...
   * all doc types
   */
  private static final List<String> MIME_DOC_LIST = Arrays.asList("odt", "ott", "sxw", "fodt", "stw", "uot", "docx",
      "doc", "rtf");

  private static final List<String> MIME_EXCEL_LIST = Arrays.asList("ods", "ots", "sxc", "stc", "fods", "uos", "xlsx",
      "xls", "xlt", "csv");

  private static final List<String> MIME_POWERPOINT_LIST = Arrays.asList("odp", "otp", "odg", "sxi", "sti", "sxg",
      "fodp", "uop", "pptx", "ppsx", "potm", "ppt", "pps");
